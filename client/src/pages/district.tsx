...
const HONG_KONG_DISTRICTS: District[] = [
  ...
  },
  {
    ...
    mtrLinesEn: "Tsim Sha Tsui MTR (Tsuen Wan Line), East Tsim Sha Tsui MTR (Tuen Ma Line)",
    mtrLinesZh: "尖沙咀港鐵站（荃灣綫）、尖東港鐵站（屯馬綫）",
  ...
  },
  {
    ...
    mtrLinesEn: "Wan Chai MTR (Island Line), Exhibition Centre MTR (Tuen Ma Line)",
    mtrLinesZh: "灣仔港鐵站（港島綫）、會展港鐵站（屯馬綫）",
  ...
  },
  {
    ...
    mtrLinesEn: "Ho Man Tin MTR (Kwun Tong/Tuen Ma Lines), Kai Tak MTR (Tuen Ma Line)",
    mtrLinesZh: "何文田港鐵站（觀塘綫/屯馬綫）、啟德港鐵站（屯馬綫）",
