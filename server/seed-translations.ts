...
const translations = [
  ...
  { key: "pets.desc", en: "Manage your pets for faster emergency requests", zh: "管理您的寵物以便快速提交緊急求助" },
  ...
  { key: "pets.delete_confirm", en: "Are you sure you want to remove this pet from your profile? This action cannot be undone.", zh: "確定要從您的個人資料中移除此寵物嗎？此操作無法復原。" },
  { key: "pets.name", en: "Name", zh: "名稱" },
  { key: "pets.name_placeholder", en: "Fluffy", zh: "毛毛" },
  { key: "pets.species", en: "Species", zh: "種類" },
  { key: "pets.species_placeholder", en: "Dog, Cat, etc.", zh: "狗、貓等" },
  { key: "pets.breed", en: "Breed (Optional)", zh: "品種（選填）" },
  { key: "pets.breed_placeholder", en: "Golden Retriever", zh: "金毛尋回犬" },
  { key: "pets.age", en: "Age (Optional)", zh: "年齡（選填）" },
  ...
  { key: "pets.medical_notes_placeholder", en: "Allergies, medications, conditions...", zh: "過敏反應、藥物、病史..." },
  { key: "pets.medical_label", en: "Medical:", zh: "醫療記錄：" },
  { key: "pets.no_pets", en: "No pets added yet", zh: "尚未新增寵物" },
  { key: "pets.add_first", en: "Add Your First Pet", zh: "新增您的第一隻寵物" },
  { key: "pets.back_to_profile", en: "Back to Profile", zh: "返回個人資料" },
  { key: "pets.update", en: "Update Pet", zh: "更新寵物" },
  { key: "pets.saving", en: "Saving...", zh: "儲存中..." },
  { key: "pets.age_years", en: "Age: {age} years", zh: "年齡：{age} 歲" },
  { key: "pets.weight_kg", en: "Weight: {weight} kg", zh: "體重：{weight} 公斤" },
  { key: "pets.success.add", en: "Pet added successfully!", zh: "已成功新增寵物！" },
  { key: "pets.success.add_desc", en: "Your pet has been added to your profile.", zh: "寵物已加入您的個人資料。" },
  { key: "pets.success.update", en: "Pet updated successfully!", zh: "已成功更新寵物！" },
